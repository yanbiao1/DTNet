...
from models import FBNet, Model, AblationModel
from models.utils import fps
from visualization import plot_pcd_one_view
from loss import emd2, l1_cd, l1_cd_batch
...
def train(params):
    ...
    train_dataset    = ShapeNet('/home/scut/hdd/liuqing_scut/datasets/PCN', 'train', params.category, True)
    test_dataset     = ShapeNet('/home/scut/hdd/liuqing_scut/datasets/PCN', 'test',  params.category)
    val_dataset      = ShapeNet('/home/scut/hdd/liuqing_scut/datasets/PCN', 'valid', params.category)
    ...
    print(f'Number of parameters: {param}')
    # print(summary(model, (10, )))
    # model = AblationModel(num_pc=256, num_down=256, ratios=[4, 8]).cuda()
    # model = FBNet().cuda()
    ...
    for epoch in range(params.start_epoch, params.epochs + 1):
        ...
        with torch.no_grad():
            ...
            for i, (in_cloud, gt_cloud) in enumerate(test_dataloader):
                ...
                total_test_l1_cd += l1_cd(pred, gt_cloud).item()
            ...
            for i, (in_cloud, gt_cloud) in enumerate(val_dataloader):
                ...
                total_val_l1_cd += l1_cd(pred, gt_cloud).item()
...
if __name__ == '__main__':
    ...
    parser.add_argument('--log_dir', type=str, default='log/DTNet/all/', help='Logger directory')
    ...
    parser.add_argument('--epochs', type=int, default=40, help='Epochs of training')
