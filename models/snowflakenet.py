...
from models.utils import PointNet_SA_Module_KNN, Transformer, MLP_Res, MLP_CONV, query_knn, grouping_operation, fps
...
class Decoder(nn.Module):
    ...
    def forward(self, feat, partial, return_P0=False):
        ...
        arr_pcd.append(pcd)
        pcd = fps(torch.cat([pcd, partial], 1), self.num_p0)
        if return_P0:
            arr_pcd.append(pcd)
        K_prev = None
