...
from pointnet2_ops.pointnet2_utils import furthest_point_sample, grouping_operation, ball_query, three_interpolate, gather_operation
...
class FBNet(nn.Module):
    ...
    def forward(self, x):
        # Coarse generation
        coarse_pcd, _ = self.coarse_net(x.transpose(1, 2).contiguous())

        # feedback refinement stage
        res_pcds = self.refine(coarse_pcd, x)
